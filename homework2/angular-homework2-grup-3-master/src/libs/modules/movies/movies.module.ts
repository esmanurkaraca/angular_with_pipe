...
import { PipeFilterPipe } from './containers/movies-table-container/pipe-filter.pipe';


@NgModule({
  declarations: [MoviesTableContainerComponent, MoviesTableComponent, PipeFilterPipe],
  imports: [
    CommonModule,
    MoviesRoutingModule,
    HttpClientModule,
